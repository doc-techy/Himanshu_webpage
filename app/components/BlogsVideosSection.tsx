...
const BlogsVideosSection = () => {
  ...
  return (
    <section id="blogs-videos" className="relative w-full bg-gradient-to-br from-[#0b6f66] via-[#0a5d54] to-[#0b6f66] py-8 md:py-12 lg:py-16 overflow-hidden">
      ...
      <div className="relative mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8 z-10">
        ...
        <div className="text-center mb-4 md:mb-6">
          <h2 className="text-2xl font-bold text-white sm:text-3xl md:text-4xl lg:text-5xl mb-2">
        ...
        <div className="flex justify-center mb-4 md:mb-6">
          <div className="inline-flex p-1 bg-white/10 backdrop-blur-sm rounded-xl border border-white/20">
            <button
              ...
              className={`flex items-center gap-2 px-4 py-2 md:px-6 md:py-2.5 rounded-lg text-sm md:text-base font-semibold transition-all duration-300 ${
                activeTab === "blogs"
                  ? "bg-[#d5a028] text-white shadow-lg"
        ...
        <div className="grid gap-3 sm:gap-4 md:gap-5 grid-cols-2 lg:grid-cols-3">
          {activeTab === "blogs" ? (
            ...
            blogs.map((blog, index) => (
              <div
                key={index}
                className="group relative rounded-xl bg-white/10 backdrop-blur-sm border border-white/20 p-3 sm:p-4 md:p-5 hover:bg-white/15 hover:border-[#d5a028]/50 transition-all duration-300 cursor-pointer"
              >
                  {/* Blog Icon */}
                  <div className="w-10 h-10 md:w-12 md:h-12 rounded-lg bg-[#d5a028]/20 flex items-center justify-center mb-3 group-hover:bg-[#d5a028]/30 transition-colors">
                    <svg className="w-5 h-5 md:w-6 md:h-6 text-[#d5a028]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                    </svg>
                  </div>

                  {/* Content */}
                  <h3 className="text-sm md:text-base font-bold text-white mb-2 group-hover:text-[#f4c430] transition-colors line-clamp-2">
                    {blog.title}
                  </h3>
            ...
            videos.map((video, index) => (
              <div
                key={index}
                className="group relative rounded-lg bg-white/10 backdrop-blur-sm border border-white/20 overflow-hidden hover:border-[#d5a028]/50 transition-all duration-300 cursor-pointer"
              >
                  ...
                  <div className="relative aspect-[16/9] overflow-hidden">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="w-8 h-8 sm:w-10 sm:h-10 lg:w-10 lg:h-10 rounded-full bg-[#d5a028] flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform">
                  ...
                  <div className="p-2 sm:p-2.5">
                    <h3 className="text-[11px] sm:text-xs font-semibold text-white mb-0.5 group-hover:text-[#f4c430] transition-colors line-clamp-1">
                      {video.title}
                    </h3>
                    <div className="flex items-center gap-1 text-[9px] sm:text-[10px] text-white/60">
        ...
        <div className="text-center mt-4 md:mt-6">
          <button className="inline-flex items-center gap-2 px-5 py-2.5 md:px-6 md:py-3 bg-[#d5a028] text-white text-sm font-semibold rounded-lg hover:bg-[#c08f1f] shadow-lg hover:shadow-xl transition-all">

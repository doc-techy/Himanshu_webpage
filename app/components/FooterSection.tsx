          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-3 pt-4">
              <a
                ...
                className="group h-11 w-11 rounded-xl bg-white/10 backdrop-blur-sm flex items-center justify-center hover:bg-[#d5a028] transition-all duration-300 hover:scale-110 hover:shadow-lg"
              >
